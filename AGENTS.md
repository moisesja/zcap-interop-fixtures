...
The ZCAP-LD Interop Fixtures is a set of neutral fixtures and runners for comparing Authorization Capabilities for Linked Data implementations across languages.
...
The systems to compare are open source projects written in .NET and Python intended to be official implementions of the [`Authorization Capabilities for Linked-Data Specification`](https://w3c-ccg.github.io/zcap-spec/).

## Parity Systems

See [`zcap-dotnet`](https://github.com/moisesja/zcap-dotnet) and [`zcap-py`](https://github.com/moisesja/zcap-py) for tracked systems.
